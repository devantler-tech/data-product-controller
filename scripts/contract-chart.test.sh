...
for invalid in 'contractProbe.url=http://example.com/schema' 'contractProbe.url=https://user:secret@example.com/schema' 'contractProbe.url=https://example.com/schema?token=secret' 'contractProbe.targetCIDR=0.0.0.0/0' 'image.digest=' 'contractProbe.monitorPodLabels=null'; do
