...
yq eval 'with(select(.kind == "Deployment" and (.metadata.labels."app.kubernetes.io/component" == "http-source" or .metadata.labels."app.kubernetes.io/component" == "contract-probe"));
